...
have made: ([See this link as well]())

```
git rebase upstream/master
```

This *should* just work.  If there are conflicts, and there sometimes are,
the rebase will be in a goofy state.  Your best bet is
```
git rebase --abort
```
